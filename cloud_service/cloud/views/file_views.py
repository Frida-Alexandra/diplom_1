...
from cloud_service.cloud.serializers.file_serializer import FileSerializer
from cloud_service.cloud.models import FileModel
...
class FileView(APIView):
    ...
    def delete(self, request):
        if request.user.is_staff:
            ...
            deleted_file = (
                FileModel.objects.filter(user_id=request.user.id)
                .all()
                .filter(id=int(request.query_params["id"]))
                .first()
            )
